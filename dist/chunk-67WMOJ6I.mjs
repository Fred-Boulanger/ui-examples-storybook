...
// src/uiExamplesGenerator.ts
var readUIExample = (filePath) => {
  try {
    const content = readFileSync(filePath, "utf8");
    const uiExample = parseYaml(content);
...
var generateComponentImports = (render, namespaces) => {
...
var generateRenderFunction = (render, namespaces) => {
...
var generateUIExampleStory = (filePath, namespaces) => {
  try {
...
var findUIExampleFiles = (directory) => {
  try {
...
// src/vite-plugin-ui-examples.ts
import { readFileSync as readFileSync2 } from "fs";
import { load as parseYaml2 } from "js-yaml";
var vite_plugin_ui_examples_default = ({
  namespaces = {}
} = {}) => ({
  ...
  createIndex: async (fileName, { makeTitle }) => {
    try {
      ...
      return [{
        type: "story",
        importPath: fileName,
        exportName: capitalize(content.label),
        // Use the story name instead of "Basic"
        title: baseTitle,
        tags
      }];
    } catch (error) {
...
export {
  ...
  findUIExampleFiles,
  vite_plugin_ui_examples_default,
  uiExamplesIndexer
};
//# sourceMappingURL=chunk-67WMOJ6I.mjs.map